    ...
    <div>
      ...
      <div className="table-wrap">
        <table className="table">
          <thead><tr><th>Customer</th><th>Product</th><th>Plan</th><th>Cycle</th><th>Next Bill</th><th>Status</th></tr></thead>
          <tbody>
            {loading ? <tr><td colSpan={6} className="text-center py-8 text-slate-500">Loading...</td></tr>
              : subs.length === 0 ? <tr><td colSpan={6} className="text-center py-8 text-slate-500">No subscriptions yet</td></tr>
              : subs.map(s => (
              <tr key={s.id}>
